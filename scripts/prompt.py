...
class SVDScanner(object):
    ...
    def build_llm(self, model_path=_MODEL_PATH, temperature=_TEMPERATURE, n_ctx=_N_CTX, max_tokens=_MAX_TOKENS, n_threads=_N_THREADS, 
                  n_gpu_layers=_N_GPU_LAYERS, grammar_path=None, verbose=_VERBOSE):
        """
...
if __name__ == "__main__":
    ...
    parser.add_argument("-s", "--system_file", dest="system_file", default="../prompts/svd_system_01.txt",
